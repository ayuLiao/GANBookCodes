...
def create_hparams():
  """Create the hparams object for generic training hyperparameters(超参数)."""
...
def create_MaskGAN(hparams, is_training):
  """Create the MaskGAN model. 创建MaskGAN网络
  ...
  #  2.  GAN REINFORCE losses. 强化学习的损失
  [
