...
class training_config(object):
    ...
    def __init__(self):
        self.gen_learning_rate = 0.01  # learning rate of generator 生成器学习速率

        self.gen_update_time = 1  # update times of generator in adversarial training 对抗训练中更新生成器的时间
        self.dis_update_time_adv = 5  # update times of discriminator in adversarial training 对抗训练中更新判别器的时间 

        self.dis_update_epoch_adv = 3  # update epoch / times of discriminator # 每一epoch更新 鉴别器的次数
        ...
        self.start_token = 0  # special start token 特殊的开始令牌
