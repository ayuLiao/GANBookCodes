...
class StarGAN(object) :
    def __init__(self, sess, args):
        ...
        self.dataset_path = r'/Users/ayuliao/Desktop/GAN/data/celetA'
        # self.dataset_path  = r'/input/celetA/'
    ...
    def gradient_panalty_deprecated(self, real, fake, scope="discriminator"):
    ...
    def test(self):
        ...
        self.saver = tf.train.Saver()
        self.checkpoint_dir = r'/Users/ayuliao/Desktop/GAN/8/model/checkpoint'
        could_load, checkpoint_counter = self.load(self.checkpoint_dir)
